...
| `packages/go/gokit`              | `go/*`                        | redesign in progress      | Problem, JWKS, JWT verifier and GoFrame Problem/auth slices pass race/vet; consumer cutover and remaining slices are pending. |
