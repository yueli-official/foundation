...
export const ADMIN_TABLER_ICON_OPTIONS: readonly AdminIconOption[] = [
  ...
  {
    label: "文档集",
    value: "i-tabler-stack-2",
    keywords: ["stack", "collection"],
  },
  ...
  {
    label: "说明",
    value: "i-tabler-file-description",
  ...
  {
    label: "代码块",
    value: "i-tabler-code-dots",
    keywords: ["code", "snippet"],
  },
  {
    label: "终端",
    value: "i-tabler-terminal-2",
  ...
  {
    label: "产品",
    value: "i-tabler-package",
    keywords: ["package", "product"],
  },
  { label: "工具", value: "i-tabler-tool", keywords: ["tool"] },
  {
    label: "设置",
    value: "i-tabler-settings",
    keywords: ["setting", "config"],
  },
  {
    label: "调整",
    value: "i-tabler-adjustments-horizontal",
    keywords: ["adjust", "filter"],
  },
  { label: "数据", value: "i-tabler-database", keywords: ["database", "data"] },
  {
    label: "数据设置",
    value: "i-tabler-database-cog",
  ...
  {
    label: "上传",
    value: "i-tabler-cloud-upload",
    keywords: ["upload", "cloud"],
  },
  {
    label: "快速开始",
    value: "i-tabler-rocket",
    keywords: ["rocket", "start"],
  },
  {
    label: "发布",
    value: "i-tabler-world-upload",
    keywords: ["publish", "deploy"],
  },
  { label: "链接", value: "i-tabler-link", keywords: ["link", "url"] },
  {
    label: "外部链接",
    value: "i-tabler-external-link",
    keywords: ["external", "link"],
  },
  { label: "目录", value: "i-tabler-sitemap", keywords: ["sitemap", "toc"] },
  {
    label: "层级",
    value: "i-tabler-hierarchy-2",
  ...
  {
    label: "添加图片",
    value: "i-tabler-photo-plus",
    keywords: ["photo", "image", "add"],
  },
  ...
  {
    label: "用户权限",
    value: "i-tabler-user-shield",
    keywords: ["user", "permission"],
  },
  {
    label: "权限",
    value: "i-tabler-shield-lock",
    keywords: ["shield", "permission"],
  },
  {
    label: "审核",
    value: "i-tabler-shield-check",
    keywords: ["shield", "review"],
  },
  {
    label: "安全",
    value: "i-tabler-lock-check",
  ...
  {
    label: "柱状图",
    value: "i-tabler-chart-bar",
    keywords: ["chart", "analytics"],
  },
  { label: "趋势", value: "i-tabler-chart-line", keywords: ["chart", "trend"] },
  { label: "搜索", value: "i-tabler-search", keywords: ["search"] },
  {
    label: "GitHub",
    value: "i-tabler-brand-github",
    keywords: ["github", "git"],
  },
  {
    label: "哔哩哔哩",
    value: "i-tabler-brand-bilibili",
    keywords: ["bilibili", "b站"],
  },
