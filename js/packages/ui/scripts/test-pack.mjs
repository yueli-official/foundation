...
try {
  ...
  const allowedFiles = [
    ...
    "package/src/admin/components/AuthorizationApplication.vue",
    "package/src/admin/components/AuthorizationGrantBadge.vue",
    "package/src/admin/components/AuthorizationUser.vue",
    "package/src/admin/components/EditorCommandBar.vue",
    ...
    "package/src/collection/components/CollectionHeaderTools.vue",
    ...
    "package/src/collection/components/CollectionPaginationBar.vue",
    ...
    "package/src/collection/edit-interaction.ts",
    ...
    "package/src/comments/admin/components/CommentModerationColumnsRow.vue",
    "package/src/comments/admin/components/CommentModerationCompactRow.vue",
    "package/src/comments/admin/components/CommentModerationToolbar.vue",
